export default function HomeMain() {
  return (
    <div className="flex flex-col items-center gap-16">
      ...
      <section className="relative flex h-[60vh] w-full items-center justify-center">
        ...
        <div className="relative z-10 rounded-lg bg-black bg-opacity-0 p-8 text-center text-white">
          ...
          <p className="mb-8 text-xl md:text-2xl">
            Formando campeones desde la cuna
          </p>
          <a
            href="#contacto"
      ...
      <section
        id="noticias"
        className="max-w-12xl w-full bg-blue-800/5 py-16 text-foreground"
      >
        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-3">
          {[
            ...
            },
            {
              ...
              description:
                "Implementamos un innovador programa de entrenamiento...",
              imageUrl:
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2">
          <div className="flex flex-col overflow-hidden rounded-lg border border-primary/20 bg-card p-6 text-card-foreground text-primary shadow-md transition-transform hover:scale-105">
            ...
            <h3 className="mb-2 text-xl font-semibold">
              Makanaky se Calatea y Acaba Frio
            </h3>
          ...
          {[
            {
              id: 1,
              imageUrl:
                "https://e.rpp-noticias.io/xlarge/2010/09/19/524895.jpg",
      ...
      <section
        id="contacto"
        className="w-full max-w-7xl rounded-xl bg-secondary p-16 text-center"
      >
        <h2 className="mb-4 text-3xl font-bold">
          ¿Listo para unirte a nosotros?
        </h2>
        <p className="mb-8 text-xl">
          Descubre todo lo que Academia Rosario tiene para ofrecerte
        </p>
